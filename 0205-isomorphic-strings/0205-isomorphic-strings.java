class Solution {
    public boolean isIsomorphic(String s, String t) {
        ...
        // for(int i = 0 ; i < t.length(); i++)
        // {
        //     if(sMap.get(i) != null && tMap.get(i) != null && sMap.get(i).size() != tMap.get(i).size()) return false;
        //     else 
        //     {
        //         Character t1 = t.charAt(i);
        //         Character s1 = s.charAt(i);
        //         if(tMap.get(i) != null)
        //         {
        //         for(int j = 0 ; j < tMap.get(t1).size(); j++)
        //         {
        //             if(tMap.get(t1).get(j) != sMap.get(s1).get(j)) return false;
        //         }
        //         }
        //     }
        // }
